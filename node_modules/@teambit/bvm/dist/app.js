...
const bvm_commands_use_1 = require("@teambit/bvm.commands.use");
const bvm_commands_version_1 = require("@teambit/bvm.commands.version");
const bvm_commands_release_1 = require("@teambit/bvm.commands.release");
const local_version_1 = require("./local-version");
let argv;
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        argv = yield (0, yargs_1.default)((0, helpers_1.hideBin)(process.argv))
            .scriptName("bvm")
            ...
            .demandCommand(1, "")
            .wrap((0, yargs_1.default)().terminalWidth())
        ...
        function showVersion(currentVersion) {
            return __awaiter(this, void 0, void 0, function* () {
                const allVersions = yield (0, bvm_commands_version_1.showAllVersions)({ overrideLocalVersion: currentVersion, includeRemote: true });
