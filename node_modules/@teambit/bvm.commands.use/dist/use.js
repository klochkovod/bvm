...
exports.command = exports.UseCmd = void 0;
...
class UseCmd {
    constructor() {
        this.aliases = ['use'];
        this.describe = 'switch used bit version';
        this.command = [
            'use [bit-version]'
        ];
    }
    ...
    handler(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!args.bitVersion) {
                ...
                return console.log(chalk_1.default.cyan(`currently use ${currentVersion} version`));
            }
            results = [yield (0, bvm_link_1.linkDefault)(args.bitVersion, { addToConfig: true })];
