...
function removeVersions(versions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const localVersions = yield (0, bvm_list_1.listLocal)();
        if (versions.includes('latest')) {
            const latestVersion = (yield (0, bvm_list_1.listLocal)()).latest().version;
            resolvedVersions = resolvedVersions.filter(version => {
                return (version !== 'latest');
            });
            resolvedVersions.push(latestVersion);
        }
        const missingVersions = (0, lodash_difference_1.default)(resolvedVersions, localVersions.toVersionsStringArray());
        const removedVersions = (0, lodash_intersection_1.default)(resolvedVersions, localVersions.toVersionsStringArray());
...
function removeAll(versionsToKeep = [], numberOfLatestToKeep = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        const localVersions = yield (0, bvm_list_1.listLocal)();
        const withoutVersionsToKeep = (0, lodash_difference_1.default)(localVersions.toVersionsStringArray(), versionsToKeep);
        let versionsToRemove = withoutVersionsToKeep;
        if (numberOfLatestToKeep > 0) {
            versionsToRemove = (0, semver_sort_1.desc)(versionsToRemove);
